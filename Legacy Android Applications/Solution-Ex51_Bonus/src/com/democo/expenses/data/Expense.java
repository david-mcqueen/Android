...
public final class Expense implements java.io.Serializable{
	...
	public static final String AUTHORITY = "com.democo.expenses.Expenses";	// How to explain?
	...
	public static final class ExpenseItem implements BaseColumns {
         ...
         */
        public static final String DEFAULT_SORT_ORDER = Expense.ExpenseItem.COLUMN_NAME_EXPENSE_DATE + " ASC";        
         ...
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.democo.kess.expense";

        /**
         * The MIME type of a {@link #CONTENT_URI} sub-directory of a single expense item
         * 
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.democo.kess.expense";
