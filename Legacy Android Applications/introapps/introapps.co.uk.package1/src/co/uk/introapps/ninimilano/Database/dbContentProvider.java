...
public class dbContentProvider extends ContentProvider{
	...
	public static final Uri CONTENT_URI_OFFER = Uri.parse(AUTHORITY + "/Offer");
	...
	static{
		...
		sURIMatcher.addURI(PROVIDER_NAME, "Offer", OFFER);
	}
	...
	public int delete(Uri uri, String whereClause, String[] whereArgs) {
		...
		case CATEGORY_FILTER:
			...
			break;
		case OFFER:
			id = db.delete(Offer.OfferItem.TABLE_NAME, whereClause, whereArgs);
		}		
		return 0;
	}
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		case CATEGORY_FILTER:
			...
			break;
		case OFFER:
			id = db.insert(Offer.OfferItem.TABLE_NAME, null, values);
		...
		// Constructs a new query builder and sets its table name
	       ...
	       switch (sURIMatcher.match(uri)){
			case TREATMENT:
				...
				break;
			case CATEGORY_PARENT:
				qb.setTables(CategoryParent.CategoryParentItem.TABLE_NAME);
				break;
			case CATEGORY_CHILD:
				qb.setTables(CategoryChild.CategoryChildItem.TABLE_NAME);
				break;
			case CATEGORY_FILTER:
				qb.setTables(CategoryFilter.CategoryFilterItem.TABLE_NAME);
				break;
			case OFFER:
				qb.setTables(Offer.OfferItem.TABLE_NAME);
				break;
			}
	...
	public static Cursor getData(String query, String[] selectionArgs){
