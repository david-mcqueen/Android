...
public class MainActivity extends FragmentActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Drawable getPageImage(int position){
			...
			case 1: //Prices
				return getResources().getDrawable(R.drawable.topcharts);
			case 2: //Loyalty
				return getResources().getDrawable(R.drawable.favorites);
			case 3: //Testimonials
				return getResources().getDrawable(R.drawable.testimonials);
			}
			return null;
		}
}
